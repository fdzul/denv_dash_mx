...
load("C:/Users/HOME/Dropbox/space_time_analysis/knox_tests/10.results/country/knox_2022_country.RData")

# Step 2. create the list of localities names ###
name_loc <- as.list(stringr::str_sub(names(knox_2022_country),
                         start = -0,
                         end = -7))

# Step 3. create the list of localities ids ###
cve_edo <- as.list(stringr::str_extract(names(knox_2022_country),
                                            pattern = "[[:digit:].,]{2}"
                                            ))


# Step 4. make the st_link maps function ####
source('C:/Users/HOME/OneDrive/proyects/spatial_analysis_dengue/space_time_analysis/knox_test/3.Functions/space_time_link_map_ver2.R')
...
knox <- purrr::pmap(.l = list(x = knox_2022_country,
                           y = name_loc,
                           z = cve_edo),
                 .f = st_link_maps)
